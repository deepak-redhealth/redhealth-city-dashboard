          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-red-100 text-sm mt-1">
                {dates ? `${dates.monthName} | MTD: ${dates.mtdStart} â ${dates.mtdEnd}` : 'Loading...'}
              </p>
            </div>
            <button
              onClick={fetchData}
...
// âââ City Row (existing) ââââââââââââââââââââââââââââââââââ
