...
import { buildHospitalFinanceQuery } from '@/lib/queries';
...
export async function GET(request) {
  try {
    ...
    const sql = buildHospitalFinanceQuery(mtdStart, mtdEnd, today, yesterday);
    ...
    console.error('Hospital Finance API error:', error);
