...
WITH raw_orders AS (
  ...
  LEFT JOIN BLADE.CORE.BLADE_ORGANIZATION_ENTITIES_NEW_FLATTENED oe
    ON bo.META_SITE_ID = oe.SITE_ID AND bo.META_ORGANIZATION_ID = oe.META_ORGANIZATION_ID
  LEFT JOIN BLADE.RAW.BLADE_ENTITY_USERS_DATA eu
    ON COALESCE(bo.META_BOOKING_CREATED_BY, bo.META_ENQUIRY_CREATED_BY, bo.META_CREATED_BY) = eu.USER_ID
      AND bo.META_ORGANIZATION_ID = eu.META_ORGANIZATION_ID
  WHERE bo.META_ORGANIZATION_ID = '${ORG_ID}'
 ...
 */
function buildCollectionsSummaryQuery(startDate, endDate, dateType, lob, cities) {
 ...
 */
function buildCollectionsHospitalQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
 ...
 */
function buildCollectionsPartnerQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
 ...
 */
function buildCollectionsEmployeeQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
...
FROM base_orders ro
LEFT JOIN BLADE.RAW.BLADE_ENTITY_USERS_DATA eu
  ON ro.created_by_id = eu.USER_ID AND ro.META_ORGANIZATION_ID = eu.META_ORGANIZATION_ID
LEFT JOIN company_receipts cr ON ro.ORDER_ID = cr.ORDER_ID
LEFT JOIN internal_outstanding io ON ro.ORDER_ID = io.ORDER_ID
LEFT JOIN external_wallet ew ON ro.ORDER_ID = ew.ORDER_ID
 ...
 */
function buildCollectionsTrendQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
 ...
 */
function buildCollectionsAgeingDetailQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
 ...
 */
function buildCollectionsB2HSummaryQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
 ...
 */
function buildCollectionsLOBSummaryQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
 ...
 */
function buildCollectionsRawReportQuery(startDate, endDate, dateType, lob, cities) {
  const baseCTE = buildBaseCTE(startDate, endDate, dateType, lob, cities);
